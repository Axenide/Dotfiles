...
class Hyprland(Service):
    ...
    def __init__(self, commands_only: bool = False, **kwargs):
        ...
        if self.HYPRLAND_SIGNATURE is None or not os.path.isdir(
            ...
            f"{self.XDG_RUNTIME_DIR}/hypr/{self.HYPRLAND_SIGNATURE}"
        ):
        ...
        self.HYPRLAND_EVENTS_SOCKET = (
            ...
            f"{self.XDG_RUNTIME_DIR}/hypr/{self.HYPRLAND_SIGNATURE}/.socket2.sock"
        )
        self.HYPRLAND_COMMANDS_SOCKET = (
            # f"/tmp/hypr/{self.HYPRLAND_SIGNATURE}/.socket.sock"
            f"{self.XDG_RUNTIME_DIR}/hypr/{self.HYPRLAND_SIGNATURE}/.socket.sock"
        )
